...
const Sidebar = () => {
  ...
  transition-all duration-300 z-20 px-4 lg:px-[35px]`}>
    ...
    <div className=' flex pl-3 gap-y-3  mt-4 rounded-lg'>
      ...
      <Link to='/' className='bg-gray-200 flex p-4 justify-center items-center text-primary w-full font-medium my-2'>View Cart</Link>
